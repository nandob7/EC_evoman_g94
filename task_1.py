...
for enemy in [2, 3, 5]:
    for i in range(10):
        ...
        mutation_chance = 0.2
        num_elite = 10
        experiment_name = f'test_4_{i + 1}_100pop_30gen_enemy{enemy}'
        directory = os.path.join("runs\ea2", experiment_name)
        ...
        def save_experiment_parameters():
            ...
            """
            log_file_path = os.path.join(directory, 'experiment_log.txt')
